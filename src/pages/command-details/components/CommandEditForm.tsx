    ...
    return (
        <div className="bg-zinc-900/70 border border-zinc-800/80 rounded-xl shadow-2xl overflow-hidden max-w-2xl mx-auto w-full">
            ...
            <div className="px-5 py-4 border-b border-zinc-800/80 flex items-center gap-3">
                ...
                <button onClick={onCancel} className="text-zinc-600 hover:text-zinc-400 transition-colors p-1 rounded-md hover:bg-zinc-800">
                    <X className="w-4 h-4" />
                </button>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-5 space-y-4">
                ...
                <div className="flex gap-3 pt-1">
                    <button
                        type="button"
                        onClick={onCancel}
                        className="flex-1 flex items-center justify-center gap-2 bg-zinc-800/60 hover:bg-zinc-800 text-zinc-400 hover:text-zinc-200 border border-zinc-700/60 font-medium px-6 py-2.5 rounded-lg transition-all duration-150 text-sm"
                    >
