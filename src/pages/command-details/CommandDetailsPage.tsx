...
export function CommandDetailsPage() {
  ...
  const [selectedCommand, setSelectedCommand] =
    useState<RegisteredCommand | null>(null);
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col font-sans">
      ...
      <header className="px-5 py-3.5 border-b border-zinc-800/80 flex items-center gap-3 bg-zinc-900/60 backdrop-blur-md sticky top-0 z-10">
        ...
        <div
          className={`w-0.5 h-7 rounded-full shrink-0 ${detailsState.is_running ? "bg-emerald-500" : detailsState.is_active ? "bg-blue-500" : "bg-zinc-700"}`}
        />

        <div className="flex-1 min-w-0">
          <h1 className="text-base font-semibold text-zinc-100 truncate leading-tight">
