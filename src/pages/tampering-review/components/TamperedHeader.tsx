            ...
            <div className="p-5 space-y-4">
                ...
                <div className="flex items-start gap-3 bg-zinc-950/50 rounded-lg p-3.5 border border-zinc-800/60">
                    ...
                    <p className="text-xs text-zinc-400 leading-relaxed">
                        {totalCommands} command{totalCommands !== 1 ? "s are" : " is"} pending review.
                        All execution has been paused until you approve. Commands are checked by default, uncheck any you want to remove. Please note that this screen will keep opening on startup until you review and confirm these changes.
                    </p>
                </div>
            </div>
        </div>
