        ...
        >
          ...
          <div className="flex items-center justify-end gap-1.5 px-2.5 py-1.5 border-t border-zinc-700/60 bg-zinc-900/40 shrink-0">
            {copied ? (
              ...
              <>
                <Copy className="w-3 h-3 text-zinc-500 group-hover/tip:text-zinc-300 transition-colors" />
                <span className="text-[10px] text-zinc-500 group-hover/tip:text-zinc-300 transition-colors">
                  Click to copy
                </span>
              </>
            )}
